            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-full flex flex-col md:flex-row items-center justify-center">
                <div className="w-64 h-64 mb-6 md:mb-0 md:mr-12 rounded-full overflow-hidden shadow-lg">
                  <img src="/lovable-uploads/me.jpg" alt="Murisa John" className="w-full aspect-square object-contain" loading="lazy" />
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-md border border-gray-100">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start"><div className="bg-legal-primary/10 p-1 rounded-full mr-2 mt-1"><svg className="h-3 w-3 text-legal-primary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg></div><p>Legal professionals spend 30-60% of their time on document review</p></li>
                  <li className="flex items-start"><div className="bg-legal-primary/10 p-1 rounded-full mr-2 mt-1"><svg className="h-3 w-3 text-legal-primary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg></div><p>Manual document analysis is prone to human error and inconsistency</p></li>
                  <li className="flex items-start"><div className="bg-legal-primary/10 p-1 rounded-full mr-2 mt-1"><svg className="h-3 w-3 text-legal-primary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg></div><p>AI can process and analyze thousands of documents in minutes</p></li>
                  <li className="flex items-start"><div className="bg-legal-primary/10 p-1 rounded-full mr-2 mt-1"><svg className="h-3 w-3 text-legal-primary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg></div><p>Legal services should be more affordable and accessible</p></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-legal-accent max-w-2xl mx-auto">LegalAI combines cutting-edge AI models with legal domain expertise.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-legal-accent">Our NLP models trained on legal texts understand complex terminology.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-legal-accent">Enterprise-grade security ensures confidentiality and compliance.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-legal-accent">AI understands context and relationships within legal documents.</p>
              </div>
            </div>
          </div>
        </section>
